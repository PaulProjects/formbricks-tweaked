/**
 * FaviconCustomizationSettings component.
 *
 * Settings card for uploading and managing a custom favicon.
...
} from "@/modules/whitelabel/favicon-customization/actions";
...
export const FaviconCustomizationSettings = ({
  organization,
  hasWhiteLabelPermission: _hasWhiteLabelPermission,
  environmentId,
  isReadOnly,
  isStorageConfigured,
